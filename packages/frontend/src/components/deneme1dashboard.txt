            ...
            <div class="activities-filter dashboard-panel">
              ...
              <div class="filter-group search-group">
                ...
                <input 
                  type="text" 
                  id="searchFilter"
                  placeholder="Aktivite adı, açıklama..." 
          ...
          <div v-if="activeMenuItem === 'discipline-rules' && isAdmin" class="discipline-rules-content">
            ...
            <div class="dashboard-panel">
              <div class="discipline-rule-tabs">
                <div 
                  v-for="rule in disciplineRules" 
                  :key="rule.disiciplineName"
              ...
              <table v-if="filteredUsers.length > 0">
                ...
                <tbody>
                  <tr v-for="user in filteredUsers" :key="user.id_number">
                    ...
                    <td class="actions">
                      <button class="action-button view" @click="viewUser(user.id_number)">
                        <i class="fas fa-eye"></i>
                      </button>
          ...
          <div class="modal-body">
            <form @submit.prevent="saveActivity">
              ...
              <div class="form-group" v-if="activityForm.category">
                ...
                <select 
                  id="activityType" 
                  v-model="activityForm.activityId"
                  required>
                  <option value="">Aktivite Türü Seçin</option>
                  <option 
                    v-for="activity in getActivitiesByCategory(activityForm.category)" 
                    :key="activity.ID" 
                    :value="activity.ID">
              ...
              <div class="form-group">
                ...
                <textarea 
                  ...
                  placeholder="Aktiviteye ilişkin açıklama ekleyin"
                  rows="4">
                </textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <input 
                  type="number" 
                  id="authorCount" 
                  v-model="activityForm.authorCount"
                  min="1"
                  required />
                <div class="help-text" v-if="activityForm.authorCount > 1">
                  {{ activityForm.authorCount }} yazarlı çalışma için çarpan: {{ getMultiplierValue(activityForm.authorCount) }}
                </div>
              </div>
